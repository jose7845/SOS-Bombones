        ...
        <Layout>
            <div className="bg-brand-50 min-h-screen py-10 animate-fade-in">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Header Typography based on image */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                        ...
                        <div className="space-y-8">
                            ...
                            <a
                                href="https://wa.me/5493876856022"
                                target="_blank"
                                rel="noreferrer"
                            ...
                            >
                                <div className="bg-[#25D366] hover:bg-[#20bd5a] text-white p-8 text-center transition-colors">
                                    <div className="flex items-center justify-center gap-3 mb-2">
                                        ...
                                        <span className="font-bold text-xl">Pedí por WhatsApp (respuesta rápida)</span>
                                    </div>
                            ...
                            <div className="bg-white p-10 rounded-3xl shadow-sm border border-brand-100">
                                <h2 className="text-3xl font-serif font-bold text-brand-900 mb-8 items-center flex gap-2">
                                    Información
                                </h2>
                                <div className="space-y-10">
                                    ...
                                    <div className="flex items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-brand-600 text-lg">Ibazeta 580</p>
                                            <a
                                                href="https://maps.app.goo.gl/a3JTcf7BYRLCDgtV6"
                                                target="_blank"
                                                rel="noreferrer"
                                                className="text-accent-600 text-sm font-bold hover:underline mt-1 inline-block"
                                            >
                                                Ver en Google Maps ›
                                            </a>
                                        </div>
                                    ...
                                    <div className="flex items-start group">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-brand-600 text-lg font-medium">3876856022</p>
                                    ...
                                    <div className="flex items-start group">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:sosbombones.salta@gmail.com" className="text-brand-600 text-lg hover:text-brand-800 transition-colors">
                                                sosbombones.salta@gmail.com
                                            </a>
                                        </div>
                                    </div>
                                </div>
